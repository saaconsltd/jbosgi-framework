...
public class BundleWiringTestCase extends OSGiFrameworkTest {
    ...
    public void testSimpleBundleWiring() throws Exception {
        ...
        wiring = hostB.adapt(BundleWiring.class);
    ...
    public void testExportedPackageFromFragment() throws Exception {
        ...
        BundleWiring wiring = hostB.getBundleRevision().getWiring();
    ...
    public void testListResources() throws Exception {
        ...
        Collection<String> resources = wiring.listResources(objectpath, "ObjectA.class", 0);
        Assert.assertEquals(1, resources.size());
        String expected = ObjectA.class.getName().replace('.', '/') + ".class";
        Assert.assertEquals(expected, resources.iterator().next());

        resources = wiring.listResources(objectpath, "*.class", 0);
        Assert.assertEquals(1, resources.size());
        Assert.assertEquals(expected, resources.iterator().next());

        resources = wiring.listResources("/org/jboss", "*.class", 0);
    ...
    public void testListResourcesWithBundleClasspath() throws Exception {
        ...
        BundleWiring wiring = hostD.adapt(BundleWiring.class);
        ...
        resources = wiring.listResources("/", "ObjectA.class", BundleWiring.LISTRESOURCES_RECURSE);
        Assert.assertEquals(1, resources.size());
        Assert.assertEquals(expected, resources.iterator().next());
    ...
    public void testListResourcesWithRequiredBundle() throws Exception {
        ...
        BundleWiring wiring = hostF.adapt(BundleWiring.class);
    ...
    public void testListResourcesLocalWithPackageSubstitute() throws Exception {
        ...
        BundleWiring wiring = hostE.adapt(BundleWiring.class);
        Collection<String> resources = wiring.listResources("/", "*.class", BundleWiring.LISTRESOURCES_RECURSE | BundleWiring.LISTRESOURCES_LOCAL);
        Assert.assertEquals(0, resources.size());
